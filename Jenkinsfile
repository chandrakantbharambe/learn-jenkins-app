        ...
        stage('Tests') {
            parallel {
                ...
                stage('E2E') {
                    ...
                    post {
                        always {
                            publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: 'playwright-report', reportFiles: 'index.html', reportName: 'E2E Test Report', reportTitles: '', useWrapperFileDirectly: true])
                        }
                    }
                }
            }
